...
docker run --name backend -d -p 80:8080 -e DOMAIN="vps753500.ovh.net" -e SMTP_USERNAME="green.jiraration@gmail.com" -e SMTP_PASSWORD="Bijour!1" -e RUST_BACKTRACE=1 dkfn/d4g:dev
